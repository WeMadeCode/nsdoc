 ...
 */
export type AICommand = 'fixSpellingAndGrammar' | 'extend' | 'shorten' | 'simplify' | 'emojify' | 'complete' | 'summarize'
...
const AI_EXCLUDED_BLOCKS = ['image', 'imageUpload', 'video', 'audio', 'table', 'codeBlock', 'horizontalRule', 'hardBreak']
